...
public interface EncryptionUtils {
  ...
  static String encryptString(SecretKey secret, String plainText) throws Exception {
  ...
  static String decryptString(SecretKey secret, String encryptedText) throws Exception {
