...
In order to use Google Tasks and Gmail APIs, follow these steps based on the [steps to configure Home Assistant Google Tasks integration](https://www.home-assistant.io/integrations/google_tasks/#scenario-2-you-do-not-have-credentials-set-up-yet):
...
9. In the left sidebar, select **Clients**:
    ...
    - Click **Create**.
10. Find the client you just created. Under the Actions column, choose **Download OAuth client** (download icon), save this as `client_secret.json` into `src/main/resources`.
...
- [Steps to configure Home Assistant Google Tasks integration](https://www.home-assistant.io/integrations/google_tasks/#scenario-2-you-do-not-have-credentials-set-up-yet)
